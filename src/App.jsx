    ...
    <dialog className="demo-dialog" ref={ref} onClose={onClose} onCancel={onClose} aria-labelledby="demo-title">
      <div className="demo-shell">
        <aside className="demo-aside">
          <img className="demo-aside-bg" src="assets/demo-aside.webp" srcSet="assets/demo-aside-500.webp 500w, assets/demo-aside.webp 1000w" sizes="(min-width: 760px) 440px, 100vw" alt="" aria-hidden="true" loading="lazy" decoding="async" />
